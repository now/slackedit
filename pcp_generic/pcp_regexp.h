...
FOREXPORT RxNode * RxCompile(const char *Regexp);
FOREXPORT int RxExec(RxNode *Regexp, const char *Data, int Len, const char *Start, RxMatchRes *Match, unsigned int RxOpt);
FOREXPORT int RxReplace(const char *rep, const char *Src, int len, RxMatchRes match, char **Dest, int *Dlen);
FOREXPORT void RxFree(RxNode *Node);
